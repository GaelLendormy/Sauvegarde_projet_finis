...
class Pagination
{
	...
	public function __construct($max_entry_page,$db)
	{
		$bdd = new PDO('mysql:host=localhost;dbname=test', 'root', '');
		$bdd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

		//On compte le nombre de message
		$return_nb_entry = $bdd->query('SELECT COUNT(*) AS total_entree FROM ' . $db );
	...
	public function setTotal_entry($total_entry,$max_entry_page)
	{
		//On calcul le nombre de page
		$nb_page = ceil($total_entry/$max_entry_page);
