...
include_once('modele/commentaires/get_billet.php');
...
include_once('modele/commentaires/get_nb_commentaires.php');
...
include_once('modele/commentaires/get_commentaires.php');
...
include_once('vue/commentaires/commentaires.php');
