	<?php
		...
		if ($actual_page != 1)
		{
			echo '<a href="blog.php?page=' . ($actual_page - 1) . '"> Préc </a>';
		}
		...
		for($numero_page = 1; $numero_page <= $nb_page; $numero_page ++ )
		{
			...
			{
				echo '<a href="blog.php?page=' . $numero_page . '"> ' . $numero_page . ' </a>';
			}
		}	
		...
		if ($actual_page != $nb_page)
		 {
				echo '<a href="blog.php?page=' . ($actual_page + 1) . '"> Suiv </a></br>';
		 }
		?>
